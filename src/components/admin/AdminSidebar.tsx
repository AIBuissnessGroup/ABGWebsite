...
const navigation = [
  ...
  { name: 'Member Levels', href: '/admin/member-levels', icon: CalendarIcon },
  { name: 'Recruitment Timeline', href: '/admin/recruitment-timeline', icon: CalendarIcon },
  { name: 'Coffee Chats', href: '/admin/coffee-chats', icon: CalendarIcon },
