          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              {session?.user?.image ? (
                ...
                <div className="w-16 h-16 bg-[#00274c] rounded-full flex items-center justify-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  {editing ? (
                    ...
                    formData.imageUrl ? (
                      <a href={formData.imageUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                        View Image
                      </a>
                    ) : (
                      <p className="text-gray-900">Not set</p>
