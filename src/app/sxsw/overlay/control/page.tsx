...
const overlays: OverlayConfig[] = [
  ...
  },
  {
    id: 'panel-combined',
    name: 'Panel Combined',
    description: 'Title intro + lower-third overlay (lightweight)',
    route: '/sxsw/overlay/panel-combined',
    params: [
      ...
      { key: 'intro', label: 'Intro Duration (sec)', type: 'number', defaultValue: '8', placeholder: 'Seconds before overlay mode' },
      { key: 'autoHide', label: 'Auto-hide Overlay (sec)', type: 'number', defaultValue: '', placeholder: 'Leave empty to stay visible' },
      ...
      { key: 's1_name', label: 'Speaker 1 Name', type: 'text', defaultValue: '', placeholder: 'Leave empty to hide' },
      { key: 's1_role', label: 'Speaker 1 Role', type: 'text', defaultValue: '' },
      { key: 's1_image', label: 'Speaker 1 Image URL', type: 'text', defaultValue: '', placeholder: 'https://...' },
      { key: 's2_name', label: 'Speaker 2 Name', type: 'text', defaultValue: '', placeholder: 'Leave empty to hide' },
      { key: 's2_role', label: 'Speaker 2 Role', type: 'text', defaultValue: '' },
      { key: 's2_image', label: 'Speaker 2 Image URL', type: 'text', defaultValue: '', placeholder: 'https://...' },
      { key: 's3_name', label: 'Speaker 3 Name', type: 'text', defaultValue: '', placeholder: 'Leave empty to hide' },
      { key: 's3_role', label: 'Speaker 3 Role', type: 'text', defaultValue: '' },
      { key: 's3_image', label: 'Speaker 3 Image URL', type: 'text', defaultValue: '', placeholder: 'https://...' },
      { key: 's4_name', label: 'Speaker 4 Name', type: 'text', defaultValue: '', placeholder: 'Leave empty to hide' },
      { key: 's4_role', label: 'Speaker 4 Role', type: 'text', defaultValue: '' },
